                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div>
                         ...
                         <div>
                            <asp:TextBox ID="tb_dateOfBirth" TextMode="MultiLine" CssClass="form-control  mt-2" runat="server" placeholder="Doğum Tarihi"></asp:TextBox>
                        </div>
                         <div>
                            <asp:TextBox ID="tb_uniformNumber" TextMode="MultiLine" CssClass="form-control  mt-2" runat="server" placeholder="Forma Numarası"></asp:TextBox>
                        </div>
                         <div>
                            <asp:TextBox ID="tb_position" TextMode="MultiLine" CssClass="form-control  mt-2" runat="server" placeholder="Mevki"></asp:TextBox>
                        </div>
                         <div class="mt-3">
                             <asp:CheckBox ID="tb_firtEleven" TextMode="MultiLine" CssClass="mt-2" runat="server" />
                             <span>İlk 11</span>

                        </div>
                         <div class="mt-3">
                             <asp:CheckBox ID="tb_status" TextMode="MultiLine" CssClass="mt-2" runat="server" />
                             <span>Kadrodamı</span>
                        </div>
                        <div>
                            <div class="mb-3 mt-2">
